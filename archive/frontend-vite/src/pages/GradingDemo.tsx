  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <header className="text-center space-y-4">
        <h1 className="text-4xl font-bold text-zinc-900 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
      ...
      {/* All Grades Overview */}
      <Card>
        <h2 className="text-2xl font-semibold mb-4 text-zinc-900">All Grades at a Glance</h2>
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          {testScores.map(({ score }) => {
            ...
            return (
              <div
                key={score}
                className="text-center p-4 rounded-lg border-2 border-gray-200 hover:bg-gray-100 hover:shadow-md transition-all"
              >
                <div className="text-5xl font-bold mb-2 text-zinc-900">{gradeInfo.letter}</div>
      ...
      {/* Size Variants */}
      <Card>
        <h2 className="text-2xl font-semibold mb-4 text-zinc-900">Size Variants</h2>
        <div className="space-y-6">
          {['sm', 'md', 'lg'].map((size) => (
            <div key={size} className="space-y-3">
              <h3 className="text-lg font-medium capitalize text-zinc-900">Size: {size}</h3>
      ...
      <Card>
        <h2 className="text-2xl font-semibold mb-4 text-zinc-900">Label Configurations</h2>
        <div className="space-y-6">
          <div className="space-y-3">
            <h3 className="text-lg font-medium text-zinc-900">With Labels</h3>
            <div className="flex flex-wrap gap-3 items-center">
              {testScores.map(({ score }) => (
