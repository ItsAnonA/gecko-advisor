  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="text-center space-y-4 py-8">
        <h1 className="text-4xl md:text-5xl font-bold text-gecko-800">Roadmap</h1>
      ...
      <section className="space-y-6 mb-12">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-3 h-3 rounded-full bg-advisor-500"></div>
          <h2 className="text-2xl md:text-3xl font-bold text-gecko-800">Live Now</h2>
        </div>
      ...
      <section className="space-y-6 mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-gecko-800">
            Coming Soon <span className="text-gecko-500 text-lg font-normal">(Q1-Q2 2025)</span>
          </h2>
        </div>
        <div className="grid gap-4 md:grid-cols-2">
          <FeatureCard
      ...
      <section className="space-y-6 mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-gecko-800">Community Requested</h2>
        </div>
        <div className="grid gap-4 md:grid-cols-2">
          <FeatureCard
            title="PDF Export"
      ...
      <section className="space-y-6 mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-gecko-800">Long-term Vision</h2>
        </div>
      ...
      {/* Call to Action */}
      <section className="p-8 rounded-xl bg-advisor-50 border border-advisor-200">
        <h3 className="text-2xl font-bold text-gecko-800 mb-4">Shape the Future</h3>
        <p className="text-gecko-600 mb-6 leading-relaxed">
          Gecko Advisor is open source and community-driven. Your feedback shapes our roadmap. Request
          features, vote on priorities, or contribute code on GitHub.
        </p>
        <a
          href="https://github.com/privacygecko/gecko-advisor/issues"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-br from-advisor-500 to-advisor-600 text-white font-semibold rounded-lg hover:scale-105 transition-transform"
        >
...
function FeatureCard({ title, description, status }: FeatureCardProps) {
  const statusConfig = {
    live: { color: 'bg-advisor-500', label: 'Live' },
  ...
  return (
    <div className="p-6 rounded-xl bg-white border border-gray-200 hover:border-advisor-200 transition-colors shadow-soft">
      <div className="flex items-start justify-between gap-4 mb-3">
        <h3 className="text-lg font-bold text-gecko-800">{title}</h3>
        <span
          className={`px-2 py-1 text-xs font-semibold rounded ${config.color} text-white whitespace-nowrap`}
        >
          {config.label}
        </span>
      </div>
