      ...
      <main className="max-w-5xl mx-auto p-6 pb-16 md:pb-24 space-y-12">
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-light-primary">
              Coming Soon <span className="text-light-tertiary text-lg font-normal">(Q1-Q2 2025)</span>
            </h2>
          </div>
          <div className="grid gap-4 md:grid-cols-2">
            <FeatureCard
        ...
        {/* Call to Action */}
        <section className="mt-12 p-8 rounded-xl bg-advisor-600/10 border border-advisor-500/30">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-br from-advisor-500 to-emerald-600 text-dark-bg font-semibold rounded-lg hover:scale-105 transition-transform"
          >
...
function FeatureCard({ title, description, status }: FeatureCardProps) {
  ...
  return (
    <div className="p-6 rounded-xl bg-dark-surface/40 border border-dark-border/30 hover:border-advisor-500/30 transition-colors">
      <div className="flex items-start justify-between gap-4 mb-3">
        <h3 className="text-lg font-bold text-light-primary">{title}</h3>
        <span className={`px-2 py-1 text-xs font-semibold rounded ${config.color} text-dark-bg whitespace-nowrap`}>
          {config.label}
        </span>
      </div>
