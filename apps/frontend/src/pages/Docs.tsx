...
export default function Docs() {
  return (
    <>
      ...
      <Card>
        <h2 id="trackers" className="text-xl font-semibold text-zinc-900">Trackers</h2>
      ...
      <Card>
        <h2 id="ssl" className="text-xl font-semibold text-zinc-900">SSL/HTTPS</h2>
        <p className="text-zinc-600 mt-2">
      ...
      <Card>
        <h2 id="scoring" className="text-xl font-semibold text-zinc-900">Scoring Bands</h2>
        <p className="text-zinc-600 mt-2">
          We compute a 0–100 score with three bands:
        </p>
        <ul className="list-disc pl-6 mt-2 text-zinc-600">
          <li><span className="font-medium text-zinc-900">Safe</span>: 70–100</li>
          <li><span className="font-medium text-zinc-900">Caution</span> (labeled "Risky" internally): 40–69</li>
          <li><span className="font-medium text-zinc-900">High Risk</span>: 0–39</li>
        </ul>
        <p className="text-zinc-600 mt-2">
      ...
      <Card>
        <h2 id="data-sharing" className="text-xl font-semibold text-zinc-900">Data Sharing Indicator</h2>
        <p className="text-zinc-600 mt-2">
        ...
        <ul className="list-disc pl-6 mt-2 text-zinc-600">
          ...
          <li>Cookie issues like missing <code className="bg-white px-1 py-0.5 rounded text-zinc-900">Secure</code>/<code className="bg-white px-1 py-0.5 rounded text-zinc-900">SameSite</code> (×1)</li>
        </ul>
        <p className="text-zinc-600 mt-2">
