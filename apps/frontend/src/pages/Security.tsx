      ...
      <main className="max-w-5xl mx-auto p-6 pb-16 md:pb-24 space-y-12">
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <NoCollectCard
              ...
              description="No analytics, no behavioral tracking, no user profiles"
            />
            <NoCollectCard
              icon="🍪"
              title="No Cookies"
              description="We analyze cookies but don't use them ourselves"
            />
            <NoCollectCard
              icon="📧"
              title="No Personal Data"
              description="No email addresses, names, or contact information collected"
            />
            <NoCollectCard
              icon="🔑"
              title="No Accounts"
              description="Anonymous by design—no login or authentication required"
            />
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <SecurityFeature
              ...
              description="TLS encryption for all connections"
            />
            <SecurityFeature
            ...
            <SecurityFeature
              ...
              description="Automated security updates via Dependabot"
            />
            <SecurityFeature
              title="Container Isolation"
              description="Docker containers for service isolation"
            />
            <SecurityFeature
              title="CI/CD Security"
              description="Automated security scanning in pipeline"
            />
            <SecurityFeature
              title="Regular Audits"
              description="Periodic security reviews and updates"
            />
          </div>
        </section>
        ...
        <section className="p-8 rounded-xl bg-gradient-to-br from-advisor-600/20 to-emerald-600/20 border border-advisor-500/30">
          ...
          <p className="text-light-secondary leading-relaxed">
            ...
            you remain anonymous. That's a promise, not marketing.
          </p>
        </section>
      </main>
      <Footer />
