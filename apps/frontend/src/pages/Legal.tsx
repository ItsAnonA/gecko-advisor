...
function TermsContent() {
  return (
    <div className="space-y-8">
      <section>
        <h2 className="text-2xl font-bold text-zinc-900 mb-4">Terms of Use</h2>
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Service Description</h3>
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Acceptable Use</h3>
        <p className="text-zinc-600 leading-relaxed mb-4">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">No Warranty</h3>
        <p className="text-zinc-600 leading-relaxed">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Limitation of Liability</h3>
        <p className="text-zinc-600 leading-relaxed">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Indemnification</h3>
        <p className="text-zinc-600 leading-relaxed">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Changes to Terms</h3>
        <p className="text-zinc-600 leading-relaxed">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Governing Law</h3>
        <p className="text-zinc-600 leading-relaxed">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Contact</h3>
        <p className="text-zinc-600 leading-relaxed">
          Questions about these terms? Contact us at{' '}
          <a href="mailto:legal@geckoadvisor.com" className="text-emerald-600 hover:text-emerald-700">
...
function PrivacyContent() {
  return (
    <div className="space-y-8">
      <section>
        <h2 className="text-2xl font-bold text-zinc-900 mb-4">Privacy Policy</h2>
        <p className="text-zinc-600 leading-relaxed">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">What We Collect</h3>
        <div className="space-y-4">
          <div>
            <h4 className="font-semibold text-zinc-900 mb-2">Submitted URLs</h4>
            <p className="text-zinc-600 leading-relaxed">
          ...
          <div>
            <h4 className="font-semibold text-zinc-900 mb-2">Scan Results</h4>
            <p className="text-zinc-600 leading-relaxed">
          ...
          <div>
            <h4 className="font-semibold text-zinc-900 mb-2">IP Addresses (Rate Limiting Only)</h4>
            <p className="text-zinc-600 leading-relaxed">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">What We DON'T Collect</h3>
        <ul className="list-disc list-inside text-zinc-600 space-y-2 ml-4">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">How We Use Data</h3>
        <ul className="list-disc list-inside text-zinc-600 space-y-2 ml-4">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Third-Party Services</h3>
        <div className="space-y-4">
          <div>
            <h4 className="font-semibold text-zinc-900 mb-2">Cloudflare</h4>
            <p className="text-zinc-600 leading-relaxed">
              We use Cloudflare for DDoS protection and CDN services. Cloudflare may process IP addresses
              for security purposes. See{' '}
              <a href="https://www.cloudflare.com/privacypolicy/" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-700">
                Cloudflare Privacy Policy
              </a>
            </p>
          </div>
          <div>
            <h4 className="font-semibold text-zinc-900 mb-2">Hosting Provider</h4>
            <p className="text-zinc-600 leading-relaxed">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Data Retention</h3>
        <ul className="list-disc list-inside text-zinc-600 space-y-2 ml-4">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Your Rights</h3>
        <div className="space-y-4">
          <div>
            <h4 className="font-semibold text-zinc-900 mb-2">GDPR (EU Users)</h4>
            <ul className="list-disc list-inside text-zinc-600 space-y-2 ml-4">
          ...
          <div>
            <h4 className="font-semibold text-zinc-900 mb-2">CCPA (California Users)</h4>
            <ul className="list-disc list-inside text-zinc-600 space-y-2 ml-4">
      ...
      <section>
        ...
        <p className="text-zinc-600 leading-relaxed">
          ...
          <a href="mailto:privacy@geckoadvisor.com" className="text-emerald-600 hover:text-emerald-700">
...
function LicenseContent() {
  return (
    <div className="space-y-8">
      <section>
        <h2 className="text-2xl font-bold text-zinc-900 mb-4">License Information</h2>
        <p className="text-zinc-600 leading-relaxed">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Gecko Advisor License (MIT)</h3>
        <p className="text-zinc-600 leading-relaxed mb-4">
        ...
        <div className="p-6 rounded-lg bg-white border border-gray-200 mb-4">
          <p className="text-zinc-600 leading-relaxed mb-4">
            <strong className="text-zinc-900">What this means:</strong>
          </p>
          <ul className="list-disc list-inside text-zinc-600 space-y-2 ml-4">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Third-Party Licenses</h3>
        <p className="text-zinc-600 leading-relaxed mb-4">
        ...
        <div className="space-y-6">
          <div className="p-6 rounded-lg bg-white border border-gray-200">
            <h4 className="text-lg font-bold text-zinc-900 mb-2">EasyPrivacy</h4>
            <p className="text-zinc-600 leading-relaxed mb-3">
              Dual licensed under GPL v3 and Creative Commons BY-SA 3.0. We use server-side for tracker detection.
            </p>
            <div className="flex flex-wrap gap-3">
              <a href="https://easylist.to/" target="_blank" rel="noopener noreferrer" className="text-sm text-emerald-600 hover:text-emerald-700">
                Official Site →
              </a>
              <a href="https://github.com/easylist/easylist" target="_blank" rel="noopener noreferrer" className="text-sm text-emerald-600 hover:text-emerald-700">
                GitHub →
              </a>
            </div>
          ...
          <div className="p-6 rounded-lg bg-white border border-gray-200">
            <h4 className="text-lg font-bold text-zinc-900 mb-2">WhoTracks.Me</h4>
            <p className="text-zinc-600 leading-relaxed mb-3">
              Licensed under Creative Commons Attribution 4.0 International (CC BY 4.0).
            </p>
            <div className="flex flex-wrap gap-3">
              <a href="https://whotracks.me/" target="_blank" rel="noopener noreferrer" className="text-sm text-emerald-600 hover:text-emerald-700">
                Official Site →
              </a>
              <a href="https://github.com/ghostery/whotracks.me" target="_blank" rel="noopener noreferrer" className="text-sm text-emerald-600 hover:text-emerald-700">
                GitHub →
              </a>
            </div>
            <p className="text-xs text-zinc-500 mt-3 italic">
          ...
          <div className="p-6 rounded-lg bg-white border border-gray-200">
            <h4 className="text-lg font-bold text-zinc-900 mb-2">Public Suffix List</h4>
            <p className="text-zinc-600 leading-relaxed mb-3">
              Licensed under Mozilla Public License.
            </p>
            <div className="flex flex-wrap gap-3">
              <a href="https://publicsuffix.org/" target="_blank" rel="noopener noreferrer" className="text-sm text-emerald-600 hover:text-emerald-700">
                Official Site →
              </a>
              <a href="https://github.com/publicsuffix/list" target="_blank" rel="noopener noreferrer" className="text-sm text-emerald-600 hover:text-emerald-700">
                GitHub →
              </a>
            </div>
            <p className="text-xs text-zinc-500 mt-3 italic">
          ...
          <div className="p-6 rounded-lg bg-white border border-gray-200">
            <h4 className="text-lg font-bold text-zinc-900 mb-2">Inter Font</h4>
            <p className="text-zinc-600 leading-relaxed mb-3">
              Licensed under SIL Open Font License 1.1.
            </p>
            <div className="flex flex-wrap gap-3">
              <a href="https://rsms.me/inter/" target="_blank" rel="noopener noreferrer" className="text-sm text-emerald-600 hover:text-emerald-700">
                Official Site →
              </a>
              <a href="https://github.com/rsms/inter" target="_blank" rel="noopener noreferrer" className="text-sm text-emerald-600 hover:text-emerald-700">
                GitHub →
              </a>
            </div>
            <p className="text-xs text-zinc-500 mt-3 italic">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Full Attribution</h3>
        <p className="text-zinc-600 leading-relaxed">
          For complete attribution and third-party licenses, see:
        </p>
        <ul className="list-disc list-inside text-zinc-600 space-y-2 ml-4 mt-3">
          <li>
            <a href="/about" className="text-emerald-600 hover:text-emerald-700">
              About & Credits Page
            </a>
          </li>
          <li>
            <a href="https://github.com/privacygecko/gecko-advisor/blob/main/NOTICE.md" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-700">
              NOTICE.md
            </a>
          </li>
          <li>
            <a href="https://github.com/privacygecko/gecko-advisor/blob/main/LICENSE-THIRD-PARTY.md" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-700">
...
function CookiesContent() {
  return (
    <div className="space-y-8">
      <section>
        <h2 className="text-2xl font-bold text-zinc-900 mb-4">Cookie Policy</h2>
        <div className="p-6 rounded-lg bg-emerald-50 border border-emerald-200 mb-6">
          <p className="text-lg text-zinc-900 font-semibold mb-3">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">What We Use Instead</h3>
        <div className="space-y-4">
          <div className="p-4 rounded-lg bg-white border border-gray-200">
            <h4 className="font-semibold text-zinc-900 mb-2">localStorage (Optional UI Preferences)</h4>
            <p className="text-zinc-600 leading-relaxed">
              We may use browser localStorage to remember:
            </p>
            <ul className="list-disc list-inside text-zinc-600 space-y-1 ml-4 mt-2">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">What We DON'T Use</h3>
        <ul className="list-disc list-inside text-zinc-600 space-y-2 ml-4">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Why No Cookies?</h3>
        <p className="text-zinc-600 leading-relaxed mb-4">
      ...
      <section>
        ...
        <p className="text-zinc-600 leading-relaxed mb-4">
          ...
          <a href="https://www.cloudflare.com/cookie-policy/" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-700">
      ...
      <section>
        <h3 className="text-xl font-bold text-zinc-900 mb-3">Your Browser Settings</h3>
        <p className="text-zinc-600 leading-relaxed">
      ...
      <section className="mt-8 p-6 rounded-lg bg-gradient-to-br from-emerald-50 to-emerald-100 border border-emerald-200">
