...
export const EvidenceCardSkeleton = React.memo(function EvidenceCardSkeleton({
  ...
  return (
    <div className={`p-4 border border-gray-200 rounded-lg space-y-3 bg-stone-50 ${className}`}>
...
export const CardSkeleton = React.memo(function CardSkeleton({
  ...
  return (
    <div className={`p-4 border border-gray-200 rounded-lg bg-stone-50 ${className}`}>
      {children || (
